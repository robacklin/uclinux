...
#define sk_rmem_alloc sk_backlog.rmem_alloc
	...
	__u32			sk_polynum_match;
	__u32			*sk_authd_ts_categories;
	__u32			*sk_authd_groups;
#endif

#ifdef CONFIG_NETFILTER_XT_MATCH_TSREPUTATION_MODULE
	__s32			sk_authd_tsreputation;
#endif
#ifdef CONFIG_NETFILTER_XT_MATCH_SOCKOPT_MODULE
	__u32			sk_authd_dev;
	__u32			sk_authd_saddr;
	__u32			sk_authd_daddr;
#endif
#ifdef CONFIG_IP_NF_SET_URLFRAG_MODULE
	const char		*sk_authd_url;
#endif
