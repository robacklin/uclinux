...
#define MCF532x_PODR_QSPI_PTR	((u8 volatile*)0xFC0A400A)
#define MCF532x_PDDR_QSPI_PTR	((u8 volatile*)0xFC0A401E)
#define MCF532x_PPDSR_QSPI_PTR	((u8 volatile*)0xFC0A4032)
#define MCF532x_PCLRR_QSPI_PTR	((u8 volatile*)0xFC0A4046)
#define MCF532x_DR_QSPI_CS0	0x08
...
static struct coldfire_spi_chip uC53281_chip_info = {
	.mode = SPI_MODE_0,
	.bits_per_word = 8,
	.del_cs_to_clk = 1,
	.del_after_trans = 1,
...
static struct spi_board_info spi_board_info[] = {
...
#if defined(CONFIG_UC53281EVM)
	{
		...
		.bus_num = 1,
		.chip_select = 0,
		.irq = MCF532x_QSPI_IRQ_VECTOR,
		.controller_data = &uC53281_chip_info
	}
#endif
};
...
#endif
#if defined(CONFIG_UC53281EVM)
static void __init uC53281EVM_init(void)
{
	/* GPIO initialization */
	MCF_GPIO_PAR_QSPI = 0xfff0;
	*(volatile u8 *) (MCFSIM_ICR0 + MCFINT_QSPI) = 5; /* level 5 */
	MCF_INTC0_IMRL &=  ~(1 << MCFINT_QSPI);
}
#endif
